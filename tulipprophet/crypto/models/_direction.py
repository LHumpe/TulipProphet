...
class CryptoDirectionModel:
    ...
    def __init__(self, data_generator: CryptoWindowGenerator,
                 ...
                 max_tokens: int, embedding_dim: int,
                 indicator_len: int,
                 max_epochs: int,
                 num_trials: int = 1,
    ...
    def _build_model(self, hp):
        ...
        dense1 = tf.keras.layers.Dense(units=hp_units_level_one, activation='relu')(merged)
        ...
        dropout1 = tf.keras.layers.Dropout(hp_dropout_level_one)(dense1)
        ...
        dense2 = tf.keras.layers.Dense(units=hp_units_level_two, activation='relu')(dropout1)
        ...
        dropout2 = tf.keras.layers.Dropout(hp_dropout_level_two)(dense2)
